    ...
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cliente != null ? 
                          ...
                          Problem("Entity set 'MiContext.Cliente'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Ci,Celular")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Ci,Celular")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MiContext.Cliente'  is null.");
            }
            var cliente = await _context.Cliente.FindAsync(id);
            if (cliente != null)
            {
