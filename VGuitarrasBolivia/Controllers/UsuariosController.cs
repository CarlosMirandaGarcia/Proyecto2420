...
namespace VGuitarrasBolivia.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Password,NombreCompleto,Rol")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Password,NombreCompleto,Rol")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
